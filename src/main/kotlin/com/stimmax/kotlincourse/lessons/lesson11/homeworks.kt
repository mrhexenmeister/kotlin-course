...
private fun unit2(int: Int, int1: Int): Int {
    return int + int1
}

//Принимает строку и ничего не возвращает.
private fun unit3(string: String) {}

//Принимает список целых чисел и возвращает среднее значение типа Double.
private fun unit4(listOfInt: List<Int>): Double {
