package org.example.com.stimmax.kotlincourse.lessons.lesson04

val v1: Byte = 42
val v2: Long = 98_765_432_123_456_789L
val v3: Float = 23.45f
val v4: Double = 0.123456789
val v5: String = "Kotlin & Java"
// val v6: Boolean = FALSE капслок
val v7: Char = 'c'
val v8: Int = 500
val v9: Long = 4_294_967_296L
val v10: Float = 18.0f
...
val v19: Float = 5.75f
// val v20: // Double должен быть, без кавычек `1.414`
...
// val v30: Boolean = FALSE капслок
val v31: Double = 0.007
val v32: String= “🤯” //чтото тут не то
val v33: Map<String, Int> = mapOf("true" to 2, "false" to 34)
// val v34: Char= ‘65535’ //неверно, нужно тогда юникод ставить, тогда чар.
val v35: Long = 72_057_594_037_927_935L
